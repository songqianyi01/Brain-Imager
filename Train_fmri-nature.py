...
outdir = f'/mnt/sda/songzengyu/code/brain_imager/trained_model/train_fmri-nature_8859*3/'
...
train_url = f"{{/mnt/sda/songzengyu/code/brain_imager/data/train/train_subj{subj_id}_{{0..17}}.tar,/mnt/sda/songzengyu/code/brain_imager/data/val/val_subj{subj_id}_0.tar}}"
val_url = f"/mnt/sda/songzengyu/code/brain_imager/data/test/test_subj{subj_id}_{{0..1}}.tar"
meta_url = f"/mnt/sda/songzengyu/code/brain_imager/data/metadata_subj{subj_id}.json"
